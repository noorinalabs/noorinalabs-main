...
**Why:** P9W26 (Parse recovery & name quality) landed 0 CI-red but concentrated **all 5 of its must-fix-received cycles + 4 rework cycles on the one name_quality/bio_promote discrimination surface** (by author: Kavitha 2, Jean-Claude 2, Alejandra 1). Across the tier's PRs — da#462/#466/#472/#473/#474/#476 — authors and reviewers independently re-derived the same gloss-tail-vs-name-cut A/B distinctions per PR; the cost held even for the *clean* PRs (Nikolaos's da#472/#473 took 0 must-fixes yet still had to re-establish the boundary by hand). The work was correct; the *cost* was the boundary being re-negotiated per PR. A shared fixture set defined at scope time makes the distinction authoritative once and turns per-PR re-derivation into per-PR verification. Relates to `feedback_query_builder_test_needs_real_engine` (verify gates against the real engine, not a string check) and the drop-gate A/B discipline (da#424).
...
<!-- Item 3 (dominant-class characterization) promoted from: P8W23 retro (2026-07-05) owner-approved process change #1 (main#923). Rationale: the #723 orphan-tail of 44,073 was framed by its most-favorable class ("accepted bio narrators") when the honest dominant class was da#317 matn-sentence pollution (~26%). Mirrored into /wave-wrapup Step 10 + /wave-retro Step 9. -->
