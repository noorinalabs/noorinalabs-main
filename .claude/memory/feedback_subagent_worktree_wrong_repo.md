...
Do not "fix" this by spawning without isolation — two agents sharing one cwd on different branches is the collision hazard in [[feedback_cwd_collision_cross_spawn]] (second checkout moves the first; commits land on the wrong branch).
