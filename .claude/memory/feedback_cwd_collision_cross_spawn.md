...
**Sibling rules**: [[feedback_verify_diagnosis_before_delegating]] (verify-via-artifact-before-action), [[feedback_refresh_before_status_claim]] (re-verify state before claims) — both share the "trust-but-verify-the-current-state" stance.
