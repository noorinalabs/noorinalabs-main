...
- [No CI on private repos (Actions minutes)](feedback_no_ci_on_private_repos.md) — Owner 2026-09-13: private repos get LOCAL pre-commit/pre-push gates, never workflows; all 8 noorinalabs/* are PUBLIC so their CI is free; tier dir names lie about visibility.
