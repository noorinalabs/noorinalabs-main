...
| Verification discipline — Verify-before-claim: run the instrument, full-read state, mocks mask prod, refresh before a status claim, re-verify stale trees. | 20 | [section_verification_discipline.md](section_verification_discipline.md) |
