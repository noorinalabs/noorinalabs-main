...
- [P7 #723 resolve pollution + OOM fixes](project_p7_narrator_pollution_resolve_fixes.md) — resolve build-host=LOCAL VM; 40% pollution fixed at NER (da#247) + matn-opener scrub (da#311/#312, 150,187 canonical). STG 07-05: scrubbed artifact ALREADY loaded + record-level verified — all 4 #723 criteria PASS (matn mw 0.013%, collection 99.96%, chains populated, search ONLINE, parallels 4.49M); crit-1 stg-VALIDATED; prod promotion owner-gated (#916).
