...
| Review / PR / merge mechanics — PR-review verdict format, reviewer rules, CI-readiness, merge ordering & wave-branch merge mechanics. | 20 | [section_review_pr_merge.md](section_review_pr_merge.md) |
