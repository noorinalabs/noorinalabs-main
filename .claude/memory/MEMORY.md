...
| CI / tooling / lint / gh-cli — CI gates, linters (ruff/actionlint/cspell), gh-cli gotchas, commit-identity and zsh/git tooling traps. | 25 | [section_ci_tooling.md](section_ci_tooling.md) |
