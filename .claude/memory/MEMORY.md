...
- [Narrator choke-points enrich](project_narrator_chokepoints_enrich.md) — 2026-07-08 betweenness enrich SHIPPED+VERIFIED on stg (150,187 narrators; real hubs al-Zuhrī/Abū Hurayra/Shuʿba/Sufyān surface). Owner HELD prod: top contaminated by over-merged generic-kunya nodes (nar:uuid5(name) collapses same-name people) → gate da#337 dedup. Bugs fixed: da#335 audit-crash (not OOM), deploy#544 name_arabic→name_ar echo, ig#1179 staging-deploy embed race.
