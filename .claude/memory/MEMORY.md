...
| Review / PR / merge mechanics — PR-review verdict format, reviewer rules, CI-readiness, merge ordering & wave-branch merge mechanics. | 18 | [section_review_pr_merge.md](section_review_pr_merge.md) |
